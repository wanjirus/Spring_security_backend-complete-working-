...
import stan.inc.payload.response.JwtResponse;
...
@Service
@AllArgsConstructor
public class RegistrationService implements AuthServiceInterface{
    @Autowired
    ...
    public String register(SignupRequest request) {
        ...
        String link = "http://localhost:8005/api/v1/users/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
